...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(100, 380, 131, 31))
        self.pushButton_10.setObjectName("pushButton_10")

        self.tableWidget_2 = QtWidgets.QTableWidget(Dialog)
        self.tableWidget_2.setGeometry(QtCore.QRect(90, 430, 881, 171))
        ...
        self.tableWidget_3.setGeometry(QtCore.QRect(260, 20, 601, 391))
        ...
        self.lineEdit.setGeometry(QtCore.QRect(130, 620, 111, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.progressBar = QtWidgets.QProgressBar(Dialog)
        self.progressBar.setGeometry(QtCore.QRect(600, 630, 241, 16))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.pushButton_7 = QtWidgets.QPushButton(Dialog)
        self.pushButton_7.setGeometry(QtCore.QRect(850, 640, 111, 51))
        self.pushButton_7.setObjectName("pushButton_7")
        self.plainTextEdit_3 = QtWidgets.QPlainTextEdit(Dialog)
        self.plainTextEdit_3.setGeometry(QtCore.QRect(270, 620, 61, 31))
        self.plainTextEdit_3.setObjectName("plainTextEdit_3")
        self.lineEdit_2 = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_2.setGeometry(QtCore.QRect(510, 630, 81, 51))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.textEdit_4 = QtWidgets.QTextEdit(Dialog)
        self.textEdit_4.setGeometry(QtCore.QRect(600, 660, 111, 31))
        self.textEdit_4.setObjectName("textEdit_4")
        self.lineEdit_3 = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_3.setGeometry(QtCore.QRect(130, 670, 111, 31))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.plainTextEdit_5 = QtWidgets.QPlainTextEdit(Dialog)
        self.plainTextEdit_5.setGeometry(QtCore.QRect(250, 670, 111, 31))
        self.plainTextEdit_5.setObjectName("plainTextEdit_5")
        self.textEdit_6 = QtWidgets.QTextEdit(Dialog)
        self.textEdit_6.setGeometry(QtCore.QRect(720, 660, 111, 31))
        ...
        # 列宽
        self.tableWidget_3.horizontalHeader().resizeSection(0, 50)
        ...
        self.tableWidget_2.horizontalHeader().resizeSection(0, 50)      # 等级
        ...
        self.pushButton_10.clicked.connect(lambda: self.version_check(6))
    ...
    def job_check(self, job):
        self.now_job = ''
        self.job_list = [self.kemu, self.duantie, self.zhujia,
                         self.diaojin, self.zhige, self.caiyi,
                         self.lianjin, self.chuzi]
    ...
    def get_level(self):
        try:
            ...
            if self.lva > self.lvb or self.lva > 99 or self.lvb > 100:
                self.textEdit.setText('1')
                self.textEdit_2.setText('100')
                self.lva = '1'
                self.lvb = '100'
    ...
    def get_exp(self, overflow_exp, add_exp):
        ...
        self.progressBar.setValue(int(a[3]))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.textEdit_2.setPlaceholderText(_translate("Dialog", "100"))
        ...
        self.pushButton_10.setText(_translate("Dialog", "金曦之遗辉（100级）"))
